...
Version  : 0.14.0
Release  : 1
URL      : https://downloads.lxqt.org/downloads/libfm-qt/0.14.0/libfm-qt-0.14.0.tar.xz
Source0  : https://downloads.lxqt.org/downloads/libfm-qt/0.14.0/libfm-qt-0.14.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1549561536
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
